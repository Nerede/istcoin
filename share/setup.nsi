...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER GGcoin
...
InstallDir $PROGRAMFILES\GGcoin
CRCCheck on
XPStyle on
BrandingText " "
ShowInstDetails show
VIProductVersion 0.6.3.0
VIAddVersionKey ProductName GGcoin
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\GGcoin.lnk" $INSTDIR\litecoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall GGcoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall GGcoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\GGcoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\GGcoin.lnk"
