...
Intro
-----
GGcoin is a free open source peer-to-peer electronic cash system that is
...
incoming connections.  GGcoin works without incoming connections,
but allowing incoming connections helps the GGcoin network.
